...
namespace Ligeris.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Upsert(int? id)
        {
            ...
            {
                /*Update*/
                productVM.Product = _unitOfWork.Product.Get(u => u.Id == id, includePropertis: "ProductImages");
                return View(productVM);
            }
        ...
        [HttpPost]
        public IActionResult Upsert(ProductVM productVM, List<IFormFile> file)
        {
            if (ModelState.IsValid)
            {
                ...
                if (file != null)
                {
                    foreach (IFormFile files in file)
                    {
                        ...
                        string productPath = @"images\products\product-" + productVM.Product.Id; //kita tambahkan nomor gambar pada product 
                ...
                TempData["success"] = "Product create/update successfully";
